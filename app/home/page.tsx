      ...
      <CardHeader className="bg-muted/30 border-b border-border/50 pb-6">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <button 
              className="h-10 w-10 flex items-center justify-center rounded-xl border border-border bg-background hover:bg-accent transition-colors disabled:opacity-50"
        ...
        <Reveal>
          <section className="relative mt-8">
            ...
            <div className="relative z-10 flex flex-col items-center text-center">
              ...
              <p className="text-lg md:text-xl text-muted-foreground font-semibold leading-relaxed mb-6 max-w-2xl mx-auto px-4">
            ...
            <Reveal key={feature.title} delay={idx * 100}>
              ...
              >
                ...
                <div className="flex items-center gap-4 mb-8">
                  ...
                  <h3 className="text-xl font-black tracking-tight uppercase">{feature.title}</h3>
                </div>
